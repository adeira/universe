...
export function isColor(value: string): boolean {
  return typeof value === 'string' && (cssColorNames.has(value) || /^#[0-9a-f]{3,6}$/i.test(value));
}
...
Object.entries(colorNamesObject).map(([name, hexValue]) => {
  return typeof hexValue === 'string' && cssColorNames.set(name, hexValue);
});
