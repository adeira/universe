...
export type AllCSSPropertyTypes = {
  ...
  +animationFillMode?: number | string, // https://developer.mozilla.org/docs/Web/CSS/animation-fill-mode
  ...
  +borderBlockEndWidth?: number | string, // https://developer.mozilla.org/docs/Web/CSS/border-block-end-width
  +borderBlockStart?: number | string, // https://developer.mozilla.org/docs/Web/CSS/border-block-start
  ...
  +borderEndStartRadius?: number | string, // https://developer.mozilla.org/docs/Web/CSS/border-end-start-radius
  +borderImage?: number | string, // https://developer.mozilla.org/docs/Web/CSS/border-image
  ...
  +borderInlineStart?: number | string, // https://developer.mozilla.org/docs/Web/CSS/border-inline-start
  ...
  +breakAfter?:  // https://developer.mozilla.org/docs/Web/CSS/break-after
    ...
    | 'initial'
    | 'unset',
  +breakBefore?:  // https://developer.mozilla.org/docs/Web/CSS/break-before
    | 'auto'
    | 'avoid'
    | 'always'
    | 'all'
    ...
    | 'initial'
    | 'unset',
  +breakInside?:  // https://developer.mozilla.org/docs/Web/CSS/break-inside
    | 'auto'
    | 'avoid'
    | 'avoid-page'
    | 'avoid-column'
    ...
    | 'initial'
    | 'unset',
  +captionSide?:  // https://developer.mozilla.org/docs/Web/CSS/caption-side
    | 'top'
    | 'bottom'
    | 'block-start'
    | 'block-end'
  ...
  +flexDirection?:  // https://developer.mozilla.org/docs/Web/CSS/flex-direction
    | 'row'
    | 'row-reverse'
    | 'column'
    | 'column-reverse'
    ...
    | 'initial'
    | 'unset',
  +flexFlow?: number | string, // https://developer.mozilla.org/docs/Web/CSS/flex-flow
  +flexGrow?: number | 'inherit' | 'initial' | 'unset', // https://developer.mozilla.org/docs/Web/CSS/flex-grow
  +flexShrink?: number | 'inherit' | 'initial' | 'unset', // https://developer.mozilla.org/docs/Web/CSS/flex-shrink
  +flexWrap?: 'nowrap' | 'wrap' | 'wrap-reverse' | 'inherit' | 'initial' | 'unset', // https://developer.mozilla.org/docs/Web/CSS/flex-wrap
  ...
  +gridAutoFlow?: number | string, // https://developer.mozilla.org/docs/Web/CSS/grid-auto-flow
  ...
  +gridTemplateColumns?: number | string, // https://developer.mozilla.org/docs/Web/CSS/grid-template-columns
  ...
  +insetInline?: number | string, // https://developer.mozilla.org/docs/Web/CSS/inset-inline
  +insetInlineEnd?: number | string, // https://developer.mozilla.org/docs/Web/CSS/inset-inline-end
  +insetInlineStart?: number | string, // https://developer.mozilla.org/docs/Web/CSS/inset-inline-start
  +isolation?: 'auto' | 'isolate' | 'inherit' | 'initial' | 'unset', // https://developer.mozilla.org/docs/Web/CSS/isolation
  ...
  +marginBlock?: number | string, // https://developer.mozilla.org/docs/Web/CSS/margin-block
  ...
  +marginLeft?: number | string, // https://developer.mozilla.org/docs/Web/CSS/margin-left
  ...
  +maskImage?: number | string, // https://developer.mozilla.org/docs/Web/CSS/mask-image
  +maskMode?: number | string, // https://developer.mozilla.org/docs/Web/CSS/mask-mode
  +maskOrigin?: number | string, // https://developer.mozilla.org/docs/Web/CSS/mask-origin
  +maskPosition?: number | string, // https://developer.mozilla.org/docs/Web/CSS/mask-position
  ...
  +maxLines?: 'none' | number | 'inherit' | 'initial' | 'unset',
  +maxWidth?: number | string, // https://developer.mozilla.org/docs/Web/CSS/max-width
  +minBlockSize?: number | string, // https://developer.mozilla.org/docs/Web/CSS/min-block-size
  ...
  +objectFit?:  // https://developer.mozilla.org/docs/Web/CSS/object-fit
    ...
    | 'initial'
    | 'unset',
  +objectPosition?: number | string, // https://developer.mozilla.org/docs/Web/CSS/object-position
  +offset?: number | string, // https://developer.mozilla.org/docs/Web/CSS/offset
  +offsetAnchor?: number | string,
  +offsetDistance?: number | string, // https://developer.mozilla.org/docs/Web/CSS/offset-distance
  +offsetPath?: number | string, // https://developer.mozilla.org/docs/Web/CSS/offset-path
  +offsetPosition?: number | string,
  +offsetRotate?: number | string, // https://developer.mozilla.org/docs/Web/CSS/offset-rotate
  +opacity?: number | string, // https://developer.mozilla.org/docs/Web/CSS/opacity
  ...
  +overflow?: number | string, // https://developer.mozilla.org/docs/Web/CSS/overflow
  ...
  +overscrollBehaviorX?: 'contain' | 'none' | 'auto' | 'inherit' | 'initial' | 'unset', // https://developer.mozilla.org/docs/Web/CSS/overscroll-behavior-x
  +overscrollBehaviorY?: 'contain' | 'none' | 'auto' | 'inherit' | 'initial' | 'unset', // https://developer.mozilla.org/docs/Web/CSS/overscroll-behavior-y
  +padding?: number | string, // https://developer.mozilla.org/docs/Web/CSS/padding
  +paddingBlock?: number | string, // https://developer.mozilla.org/docs/Web/CSS/padding-block
  +paddingBlockEnd?: number | string, // https://developer.mozilla.org/docs/Web/CSS/padding-block-end
  +paddingBlockStart?: number | string, // https://developer.mozilla.org/docs/Web/CSS/padding-block-start
  +paddingBottom?: number | string, // https://developer.mozilla.org/docs/Web/CSS/padding-bottom
  +paddingInline?: number | string, // https://developer.mozilla.org/docs/Web/CSS/padding-inline
  +paddingInlineEnd?: number | string, // https://developer.mozilla.org/docs/Web/CSS/padding-inline-end
  +paddingInlineStart?: number | string, // https://developer.mozilla.org/docs/Web/CSS/padding-inline-start
  ...
  +pageBreakAfter?:  // https://developer.mozilla.org/docs/Web/CSS/page-break-after
    ...
    | 'initial'
    | 'unset',
  +pageBreakBefore?:  // https://developer.mozilla.org/docs/Web/CSS/page-break-before
    | 'auto'
    | 'always'
    | 'avoid'
    | 'left'
  ...
  +rubyAlign?:  // https://developer.mozilla.org/docs/Web/CSS/ruby-align
    | 'start'
    | 'center'
    | 'space-between'
    | 'space-around'
  ...
  +transitionTimingFunction?: number | string, // https://developer.mozilla.org/docs/Web/CSS/transition-timing-function
  +translate?: number | string, // https://developer.mozilla.org/docs/Web/CSS/translate
  +unicodeBidi?:  // https://developer.mozilla.org/docs/Web/CSS/unicode-bidi
    | 'normal'
    | 'embed'
    | 'isolate'
    | 'bidi-override'
