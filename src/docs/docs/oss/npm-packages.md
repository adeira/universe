...
- 1.2.0 [@kiwicom/babel-plugin-orbit-components](https://github.com/kiwicom/babel-plugin-orbit-components#readme) - A babel plugin for transforming destructured imports to granular ones.
