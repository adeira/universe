...
- 8.1.1 [@kiwicom/eslint-config](https://github.com/kiwicom/eslint-config-kiwicom) - Eslint configuration describing rules for JS used at Kiwi.com.
...
- 0.4.0 [@kiwicom/flow-bin](https://gitlab.skypicker.com/incubator/universe/tree/master/src/packages/flow-bin) - Our custom wrapper around flow-bin with some additional default features like lazy mode and saved state.
