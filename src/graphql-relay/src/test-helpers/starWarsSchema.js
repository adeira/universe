...
import { connectionArgs, connectionDefinitions } from '../connection/connection';
import { mutationWithClientMutationId } from '../mutation/mutation';
import { getFaction, getShip, getRebels, getEmpire, createShip } from './starWarsData';
...
const factionType = new GraphQLObjectType({
  ...
  fields: () => ({
    ...
    ships: {
      ...
      args: connectionArgs,
      resolve: (faction, args) => connectionFromArray(faction.ships.map(getShip), args),
    },
  }),
});
