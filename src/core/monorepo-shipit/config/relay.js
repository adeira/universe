...
module.exports = {
  ...
  getPathMappings(): Map<string, string> {
    return new Map([
      ['src/packages/relay/.eslintrc.js', 'STRIPPED'], // our original Eslint config is being removed and replaced with the one from __github__
  ...
  getStrippedFiles(): Set<RegExp> {
    return new Set([/__github__/, /^STRIPPED$/]);
  },
};
