...
const TITLE = 'Adeira DOC';

const FONTS_BASE_URL = '/fonts';

function collectHeadings(node, sections = []): $ReadOnlyArray<$FlowFixMe> {
  if (node) {
...
export default function MyApp(props: $FlowFixMe): Node {
  ...
  return (
    <div className={`${isLandingPage ? 'page--landing' : ''}`}>
      <Head>
        ...
        <meta property="og:image" content="https://markdoc.io/images/share.png" />
        <meta name="twitter:card" content="summary" />
        <meta name="twitter:image" content="https://markdoc.io/images/share.png" />
      </Head>
      ...
      <TopNav>
        <Link href="/docs/welcome">Docs</Link>
        <Link href="https://github.com/adeira/universe">GitHub</Link>
      </TopNav>
      <div className="page">
        {isDocs ? <SideNav /> : null}
      ...
      <style jsx global>
        {`
          @font-face {
            ...
            font-style: normal;
            font-weight: normal;
            src: url('${FONTS_BASE_URL}/GT-America-Mono-Regular.otf') format('opentype');
          }
          ...
          @font-face {
            ...
            font-style: normal;
            font-weight: 500;
            src: url('${FONTS_BASE_URL}/GT-America-Mono-Medium.otf') format('opentype');
          }
          ...
          .footer-bar footer {
            margin: 0 auto;
            max-width: ${isLandingPage ? 'var(--landing-page-max-width)' : 'calc(100% - 4rem)'};
          }
          ...
          .page--landing .section hr {
            ...
            margin: 6.5rem 0;
            height: 2px;
            background-image: linear-gradient(to right, var(--dark) 33%, rgba(255, 255, 255, 0) 0%);
