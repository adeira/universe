...
def raze_fetch_remote_crates():
    ...
    maybe(
        ...
        commit = "0f5ea8bdad5c38315c24b7c2297f06c9293f5fd1",
    ...
    maybe(
        ...
        build_file = Label("//third_party/cargo/remote:BUILD.async-compression-0.3.7.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/cargo/remote:BUILD.matchers-0.0.1.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/cargo/remote:BUILD.parking_lot_core-0.8.2.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/cargo/remote:BUILD.regex-automata-0.1.9.bazel"),
    )
    ...
    maybe(
        http_archive,
        name = "raze__sharded_slab__0_1_1",
        url = "https://crates.io/api/v1/crates/sharded-slab/0.1.1/download",
        type = "tar.gz",
        sha256 = "79c719719ee05df97490f80a45acfc99e5a30ce98a1e4fb67aee422745ae14e3",
        strip_prefix = "sharded-slab-0.1.1",
        build_file = Label("//third_party/cargo/remote:BUILD.sharded-slab-0.1.1.bazel"),
    )
    ...
    maybe(
        http_archive,
        name = "raze__tokio__1_1_1",
        url = "https://crates.io/api/v1/crates/tokio/1.1.1/download",
        type = "tar.gz",
        sha256 = "6714d663090b6b0acb0fa85841c6d66233d150cdb2602c8f9b8abb03370beb3f",
        strip_prefix = "tokio-1.1.1",
        build_file = Label("//third_party/cargo/remote:BUILD.tokio-1.1.1.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/cargo/remote:BUILD.tokio-tungstenite-0.13.0.bazel"),
    )

    maybe(
        http_archive,
        name = "raze__tokio_util__0_6_3",
        ...
        build_file = Label("//third_party/cargo/remote:BUILD.tokio-util-0.6.3.bazel"),
    )
    ...
    maybe(
        http_archive,
        name = "raze__tracing_log__0_1_1",
        url = "https://crates.io/api/v1/crates/tracing-log/0.1.1/download",
        type = "tar.gz",
        sha256 = "5e0f8c7178e13481ff6765bd169b33e8d554c5d2bbede5e32c356194be02b9b9",
        strip_prefix = "tracing-log-0.1.1",
        build_file = Label("//third_party/cargo/remote:BUILD.tracing-log-0.1.1.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/cargo/remote:BUILD.tracing-serde-0.1.2.bazel"),
    )

    maybe(
        http_archive,
        name = "raze__tracing_subscriber__0_2_15",
        url = "https://crates.io/api/v1/crates/tracing-subscriber/0.2.15/download",
        type = "tar.gz",
        sha256 = "a1fa8f0c8f4c594e4fc9debc1990deab13238077271ba84dd853d54902ee3401",
        strip_prefix = "tracing-subscriber-0.2.15",
        build_file = Label("//third_party/cargo/remote:BUILD.tracing-subscriber-0.2.15.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//third_party/cargo/remote:BUILD.tungstenite-0.12.0.bazel"),
    )
    ...
    maybe(
        http_archive,
        name = "raze__warp__0_3_0",
        url = "https://crates.io/api/v1/crates/warp/0.3.0/download",
        type = "tar.gz",
        sha256 = "3dafd0aac2818a94a34df0df1100a7356c493d8ede4393875fd0b5c51bb6bc80",
        strip_prefix = "warp-0.3.0",
        build_file = Label("//third_party/cargo/remote:BUILD.warp-0.3.0.bazel"),
    )
