...
declare type $npm$redis$SetCallbackAllOk = (
  error: ?Error,
  result: 'OK',
) => void;
...
declare type $npm$redis$DelCallback = (
  error: ?Error,
  numRemoved: number,
) => void;
...
declare type $npm$redis$DelWithRestKeys = (...keys: Array<string>) => void;
...
declare module 'redis' {
  declare class RedisClient extends events$EventEmitter
    ...
    flushall: (callback?: (error: ?Error, result: 'OK') => void) => void;
    publish: (
      topic: string,
      value: any,
  ...
  declare class RedisClientPromisified extends RedisClient {
    ...
    msetAsync: (keysAndValues: Array<string>) => Promise<string>;
